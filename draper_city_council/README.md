...
| Election results | 2007 → 2025 | **24 races** · candidate + precinct tables | Salt Lake County SOVC (+ 2019 & 2025 raw re-parse) + **1 city-sourced canceled race** | ✅ verified; **all AT-LARGE**; 2019 general + 2021 general recovered; **2025 re-parsed** (upstream county long-file bug); the 2025 **canceled-uncontested** 4-yr council race (Res #25-49, UCA 20A-1-206(3) — T. Lowery + M. Green certified, no ballot ⇒ blank tallies) added 2026-07-31; winners match outside sources |
