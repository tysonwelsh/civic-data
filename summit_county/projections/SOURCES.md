# Summit County / projections — sources & provenance

All values in `summit_county_projections.csv` are **extracted verbatim** from the
...
- **Horizon:** annual 2025 → 2065. Summit County rows in CSV: 5-year snapshots 2025–2065 (9 years).
...
The workbook's `Demographic Detail` sheet is one row per county × year. For Summit County we
...
Summit County 5-year snapshots are lifted into the CSV.

## Sanity check (against Gardner headline figures)

- **Vintage 2025 population:** 43,374 (2025) → 56,650 (2065), a 30.6% 40-year change.
- **Vintage 2025 jobs:** 51,653 (2025) → 81,922 (2065).
- **Vintage 2022 population:** 42,394 (2020) → 59,603 (2060).
