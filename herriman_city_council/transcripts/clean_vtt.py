...
transcript (Herriman City). Strips <c>/<timestamp> inline tags and collapses
...
HDR = ("**AUTOMATIC TRANSCRIPTION — ASR, expect word errors; not an official "
       "record.** YouTube auto-generated captions from the Herriman City "
...
def main():
    ...
    md = (f"# Herriman City — {body} meeting stream, {date} (AUTOMATIC TRANSCRIPTION)\n\n"
          f"> {HDR}\n\n"
          f"- **Date:** {date}\n- **Body (inferred):** {body}\n"
          f"- **Video:** https://www.youtube.com/watch?v={vid}\n"
          f"- **Channel:** Herriman City (youtube.com/channel/UCBFfCj0QT3f_2UfBE45al1w)\n"
