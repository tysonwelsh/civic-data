# Cache County / projections — sources & provenance

All values in `cache_county_projections.csv` are **extracted verbatim** from the
...
- **Horizon:** annual 2025 → 2065. Cache County rows in CSV: 5-year snapshots 2025–2065 (9 years).
...
The workbook's `Demographic Detail` sheet is one row per county × year. For Cache County we
...
Cache County 5-year snapshots are lifted into the CSV.

## Sanity check (against Gardner headline figures)

- **Vintage 2025 population:** 145,171 (2025) → 224,129 (2065), a 54.4% 40-year change.
- **Vintage 2025 jobs:** 93,669 (2025) → 122,353 (2065).
- **Vintage 2022 population:** 133,743 (2020) → 226,084 (2060).
