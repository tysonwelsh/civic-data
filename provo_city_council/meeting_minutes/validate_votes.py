...
KNOWN_TALLY_MISMATCHES = {
    # ("2022-11-01", "5") was listed here as a logged extraction gap ('Opposed were
    # Shipley, Hoban and Ellsworth' phrasing missed); FIXED 2026-07-02 (plan 3.5) --
    # the extractor now parses inverted cue phrasing and the 3 Nay rows are present.
    ("2023-05-02", "6"):
        "faithful source contradiction: the vote line reads 'approved 5:0' but names "
        "SEVEN councilors in favor incl. Fillmore and Handley, who are recorded excused "
        "in every other vote that meeting (clerk copy-paste); the 7 printed names are "
        "kept verbatim.",
}
