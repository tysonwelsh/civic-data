...
KNOWN_NOTES = [
    "2 unanimity-vs-roll quirks documented in meeting_minutes/CLAUDE.md (2021-06-03 m7, "
    "2021-11-18 m15: minutes say 'unanimous' but the roll records a Nay) -- their result "
    "strings carry no numeric tally, so they do not enter the tally check here; the "
    "dataset's own extractor validation reports them.",
]
# ---------------------------------------------------------------------------
