# Washington County / projections — sources & provenance

All values in `washington_county_projections.csv` are **extracted verbatim** from the
...
- **Horizon:** annual 2025 → 2065. Washington County rows in CSV: 5-year snapshots 2025–2065 (9 years).
...
The workbook's `Demographic Detail` sheet is one row per county × year. For Washington County we
...
Washington County 5-year snapshots are lifted into the CSV.

## Sanity check (against Gardner headline figures)

- **Vintage 2025 population:** 209,084 (2025) → 384,339 (2065), a 83.8% 40-year change.
- **Vintage 2025 jobs:** 139,092 (2025) → 212,398 (2065).
- **Vintage 2022 population:** 182,111 (2020) → 464,528 (2060).
