# Juab County / projections — sources & provenance

All values in `juab_county_projections.csv` are **extracted verbatim** from the
...
- **Horizon:** annual 2025 → 2065. Juab County rows in CSV: 5-year snapshots 2025–2065 (9 years).
...
The workbook's `Demographic Detail` sheet is one row per county × year. For Juab County we
...
Juab County 5-year snapshots are lifted into the CSV.

## Sanity check (against Gardner headline figures)

- **Vintage 2025 population:** 13,386 (2025) → 21,259 (2065), a 58.8% 40-year change.
- **Vintage 2025 jobs:** 6,674 (2025) → 8,965 (2065).
- **Vintage 2022 population:** 11,831 (2020) → 23,331 (2060).
