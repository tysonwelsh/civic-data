...
KNOWN_TALLY_MISMATCHES = {
    ("2020-09-30", "1"): "not a tally: the result sentence cites Utah Code Annotated "
        "52-4-204 (closed-session 2/3 supermajority requirement) and motions_std's "
        "tally regex reads '52-4' as 52:4; the named roll (3 Aye / 2 Nay, motion "
        "FAILED for lack of a supermajority) is verified against the PMN-recovered "
        "2020-09-30 special work meeting minutes (promotion pass 2026-07-16)",
}
# Free-text, hand-verified notes appended to the report (known source typos etc.).
KNOWN_NOTES = [
    "THE MAYOR VOTES in Herriman (council-mayor form): every named roll call includes 'Mayor <Name>' Aye/Nay, so a complete council tally is 5 (4 districts + mayor), not 4 (David Watts 2020-21, Lorin Palmer 2022+). Corrects recon.md.",
]
# ---------------------------------------------------------------------------
