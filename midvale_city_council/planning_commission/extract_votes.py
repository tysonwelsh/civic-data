...
CFG = {
    "council": {
        "roles": r"(?:Council\s*Member|Councilmember|Mayor\s*Pro[-\s]?Tem(?:pore)?|"
                 r"Mayor|Council\s*President)",
