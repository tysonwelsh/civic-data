# Juab County / projections — population & housing projections

Small, high-value structured table of **long-term population, household, and employment
projections for Juab County** from the **Kem C. Gardner Policy Institute** (University of
...
- `juab_county_projections.csv` — **canonical.** Long-format, one row per
...
| column | meaning |
|---|---|
| `geography` | `Juab County` (only geography present) |
...
Juab County population 13,386 (2025) → 21,259 (2065), a 58.8% 40-year change; jobs
6,674 → 8,965. Under the prior Vintage 2022, population ran 11,831 (2020) → 23,331
...
new `...State-and-County-Projections-<yrs>-Data.xlsx`, extract the Juab County rows for the
