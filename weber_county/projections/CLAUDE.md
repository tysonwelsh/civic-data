# Weber County / projections — population & housing projections

Small, high-value structured table of **long-term population, household, and employment
projections for Weber County** from the **Kem C. Gardner Policy Institute** (University of
...
- `weber_county_projections.csv` — **canonical.** Long-format, one row per
...
| column | meaning |
|---|---|
| `geography` | `Weber County` (only geography present) |
...
Weber County population 273,234 (2025) → 385,763 (2065), a 41.2% 40-year change; jobs
167,182 → 223,666. Under the prior Vintage 2022, population ran 262,726 (2020) → 396,265
...
new `...State-and-County-Projections-<yrs>-Data.xlsx`, extract the Weber County rows for the
