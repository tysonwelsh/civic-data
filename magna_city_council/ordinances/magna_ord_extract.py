#!/usr/bin/env python3
"""magna_ord_extract.py — text sidecars for Magna ordinance/resolution raws.
...
(no shell `timeout`). Many MunicipalCodeOnline copies are SCANS -> OCR-bound.
...
Usage: python3 magna_ord_extract.py
"""
import csv
import os
import subprocess
...
SCRATCH = ("/private/tmp/claude-501/-Users-tysonwelsh-civic-data/"
           "8fb286a3-d584-4f76-9af3-7bf139a225b8/scratchpad/magna_ord_ocr")
MIN_CHARS = 200
