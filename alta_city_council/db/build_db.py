...
planning_commission/all_votes.csv and writes the Town of Alta's SQLite db +
tables/ exports, with the fail-loud db/vote_overrides.csv reconciliation. Idempotent.
