...
KNOWN_TALLY_MISMATCHES = {
    ("2020-08-18", "2"):
        "partial dissent-only record: the minutes print '4-1' without a full roll but "
        "name the single dissenter -- the 1 recorded Nay is genuine, the 4 Ayes are "
        "unnamed by the source (result string itself says '(no names)').",
}
