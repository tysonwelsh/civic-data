# Washington County / projections — population & housing projections

Small, high-value structured table of **long-term population, household, and employment
projections for Washington County** from the **Kem C. Gardner Policy Institute** (University of
...
- `washington_county_projections.csv` — **canonical.** Long-format, one row per
...
| column | meaning |
|---|---|
| `geography` | `Washington County` (only geography present) |
...
Washington County population 209,084 (2025) → 384,339 (2065), a 83.8% 40-year change; jobs
139,092 → 212,398. Under the prior Vintage 2022, population ran 182,111 (2020) → 464,528
...
new `...State-and-County-Projections-<yrs>-Data.xlsx`, extract the Washington County rows for the
