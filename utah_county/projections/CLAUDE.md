# Utah County / projections — population & housing projections

Small, high-value structured table of **long-term population, household, and employment
projections for Utah County** from the **Kem C. Gardner Policy Institute** (University of
...
- `utah_county_projections.csv` — **canonical.** Long-format, one row per
...
| column | meaning |
|---|---|
| `geography` | `Utah County` (only geography present) |
...
Utah County population 772,019 (2025) → 1,543,744 (2065), a 100.0% 40-year change; jobs
471,008 → 752,908. Under the prior Vintage 2022, population ran 664,258 (2020) → 1,338,222
...
new `...State-and-County-Projections-<yrs>-Data.xlsx`, extract the Utah County rows for the
