# Weber County / projections — sources & provenance

All values in `weber_county_projections.csv` are **extracted verbatim** from the
...
- **Horizon:** annual 2025 → 2065. Weber County rows in CSV: 5-year snapshots 2025–2065 (9 years).
...
The workbook's `Demographic Detail` sheet is one row per county × year. For Weber County we
...
Weber County 5-year snapshots are lifted into the CSV.

## Sanity check (against Gardner headline figures)

- **Vintage 2025 population:** 273,234 (2025) → 385,763 (2065), a 41.2% 40-year change.
- **Vintage 2025 jobs:** 167,182 (2025) → 223,666 (2065).
- **Vintage 2022 population:** 262,726 (2020) → 396,265 (2060).
